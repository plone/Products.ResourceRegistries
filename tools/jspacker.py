...
class JavaScriptPacker:
    ...
    def getEncoder(self, ascii):
        ...
        def encode36(charCode):
            ...
            remainder = charCode
            while 1:
                result, remainder = divmod(remainder, 63)
    ...
    def analyze(self, script, regexp, encode):
        ...
        if all:
            ...
            for word in unsorted:
                if word in _protected and _protected[word]:
    ...
    def bootStrap(self, packed, keywords, encoding, fastDecode):
        ...
        if fastDecode:
            # create the decoder
            #decode = _getFunctionBody(_decode);
            ...
            #if (!$count) $decode = $decode.replace(/(\$count)\s*=\s*1/, "$1=0");
            pass
    ...
    def pack(self, script, encoding=0, fastDecode=False, specialChars=False):
        script = script+"\n"
...
cssQuery.toString = function() {
    ...
    return $name + $$dummy;
}""", 0, False, True, """function test(_0){var n=1;var du=2;return n+du}"""))
